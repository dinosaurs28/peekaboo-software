        ...
        <main className="flex-1 p-6 space-y-6">
          ...
          {previewCsv && (
            <div className="space-y-2">
              ...
              <pre className="border rounded-md p-2 max-h-64 overflow-auto text-xs whitespace-pre-wrap">
                {previewCsv.split("\n").slice(0, 21).join("\n")}
              </pre>
            </div>
          )}
          ...
          <div className="pt-6 border-t">
            <button
              className="px-4 py-3 rounded-md bg-emerald-600 text-white text-sm font-medium"
